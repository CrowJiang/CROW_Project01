...
public class RetrofitRepository implements Repository {
    ...
    @Override
    public Observable<CommonBean> getFindCinema(int x, int y) {
        return mMovieApiService.getFindCinema(x, y);
    ...
    @Override
    public Observable<MySpaceBean> getMySpaceMovie(int start, int count) {
