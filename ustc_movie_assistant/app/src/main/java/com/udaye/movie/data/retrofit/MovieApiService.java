...
public interface MovieApiService {
    ...
    //http://api.douban.com/v2/movie/coming_soon?start=0&count=5  未实现
    @GET("v2/movie/*")
    Observable<CommonBean> getFindCinema(@Query("x") int x,
                                               @Query("y") int y
    );
    ...
    @GET("v2/movie/top250")
    Observable<MySpaceBean> getTop250Movie(@Query("start") int start,
