 ...
 * 周边影院
 */
public class FindCinemaAdapter extends com.udaye.library.pullloadlibrary.RecyclerViewCommonAdapter<CommonBean.SubjectsBean> {


    public FindCinemaAdapter(List<CommonBean.SubjectsBean> list, Context context) {
